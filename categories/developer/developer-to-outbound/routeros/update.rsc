...
add dont-require-permissions=no name=update-developer-outbound owner=admin policy=ftp,read,write,policy,test source=":local fileName \"developer-outbound.rsc\"
...
:if (\$payloadSize = 0) do={ /file remove [find name=\$fileName]; :log warning \"Developer outbound update: downloaded file failed validation; keeping old list\"; :return \"\" }
