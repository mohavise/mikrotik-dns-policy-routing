...
:do { add list=DST-ONEDRIVE-TO-OUTBOUND address=52.104.0.0/14 comment="onedrive-cidr" } on-error={}
:do { add list=DST-ONEDRIVE-TO-OUTBOUND address=52.108.0.0/14 comment="onedrive-cidr" } on-error={}
