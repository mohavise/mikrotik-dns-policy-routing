...
:if (\$fileSize < \$minFileSize) do={ :log warning (\"Windows Update outbound update: downloaded file too small (\" . \$fileSize . \" bytes); keeping old list\"); /file remove \$fileName; :return }
