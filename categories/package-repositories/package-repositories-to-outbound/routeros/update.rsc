...
:if (\$payloadSize = 0) do={ /file remove [find name=\$fileName]; :log warning \"Package repositories outbound update: downloaded file failed validation; keeping old list\"; :return \"\" }
