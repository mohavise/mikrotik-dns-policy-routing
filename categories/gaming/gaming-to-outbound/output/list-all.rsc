...
:do { add list=DST-GAMING-TO-OUTBOUND address=103.10.124.0/23 comment="steam-cidr" } on-error={}
...
:do { add list=DST-GAMING-TO-OUTBOUND address=155.133.224.0/21 comment="steam-cidr" } on-error={}
:do { add list=DST-GAMING-TO-OUTBOUND address=155.133.236.0/22 comment="steam-cidr" } on-error={}
...
:do { add list=DST-GAMING-TO-OUTBOUND address=155.133.248.0/22 comment="steam-cidr" } on-error={}
:do { add list=DST-GAMING-TO-OUTBOUND address=155.133.252.0/24 comment="steam-cidr" } on-error={}
:do { add list=DST-GAMING-TO-OUTBOUND address=155.133.254.0/23 comment="steam-cidr" } on-error={}
:do { add list=DST-GAMING-TO-OUTBOUND address=162.254.192.0/21 comment="steam-cidr" } on-error={}
:do { add list=DST-GAMING-TO-OUTBOUND address=185.25.180.0/24 comment="steam-cidr" } on-error={}
:do { add list=DST-GAMING-TO-OUTBOUND address=185.25.182.0/23 comment="steam-cidr" } on-error={}
...
:do { add list=DST-GAMING-TO-OUTBOUND address=208.64.200.0/22 comment="steam-cidr" } on-error={}
