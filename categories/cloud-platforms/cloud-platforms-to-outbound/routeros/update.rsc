...
:if (\$payloadSize = 0) do={ /file remove [find name=\$fileName]; :log warning \"Cloud platforms outbound update: downloaded file failed validation; keeping old list\"; :return \"\" }
