...
# Last update: 2026-07-19 14:19:56 UTC
...
/ip dns static
:do { add regexp="(^|.*\\.)redd\\.it\$" type=FWD address-list=DST-TO-OUTBOUND comment="reddit:redd.it" } on-error={}
:do { add regexp="(^|.*\\.)reddit\\.com\$" type=FWD address-list=DST-TO-OUTBOUND comment="reddit:reddit.com" } on-error={}
:do { add regexp="(^|.*\\.)redditmedia\\.com\$" type=FWD address-list=DST-TO-OUTBOUND comment="reddit:redditmedia.com" } on-error={}
:do { add regexp="(^|.*\\.)redditstatic\\.com\$" type=FWD address-list=DST-TO-OUTBOUND comment="reddit:redditstatic.com" } on-error={}
