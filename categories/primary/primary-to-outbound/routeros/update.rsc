...
add dont-require-permissions=no name=update-outbound owner=admin policy=ftp,read,write,policy,test source=":local fileName \"outbound.rsc\"
...
:if (\$payloadSize = 0) do={ /file remove [find name=\$fileName]; :log warning \"Primary outbound update: downloaded file failed validation; keeping old list\"; :return \"\" }
