# Primary To Outbound Profile

This profile represents the primary MikroTik address-list target:
...
Use this profile when a router should install all selected outbound destinations through one address-list.
