...
profile_list="DST-AI-TO-OUTBOUND"
last="$(date -u '+%Y-%m-%d %H:%M:%S UTC')"
services_file="$repo_root/groups/ai/services.txt"
...

{
    ...
    echo "# profile=ai-to-outbound"
    echo "# List: AI combined domains + CIDR"
...
printf 'Generated ai profile output\n'
