...
profile_list="DST-PACKAGE-REPOSITORIES-TO-OUTBOUND"
last="$(date -u '+%Y-%m-%d %H:%M:%S UTC')"
services_file="$repo_root/groups/package-repositories/services.txt"
...

{
    ...
    echo "# profile=package-repositories-to-outbound"
    echo "# List: Package Repositories combined domains + CIDR"
...
printf 'Generated package repositories profile output\n'
