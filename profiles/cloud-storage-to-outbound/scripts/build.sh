...
profile_list="DST-CLOUD-STORAGE-TO-OUTBOUND"
last="$(date -u '+%Y-%m-%d %H:%M:%S UTC')"
services_file="$repo_root/groups/cloud-storage/services.txt"
...

{
    ...
    echo "# profile=cloud-storage-to-outbound"
    echo "# List: Cloud Storage combined domains + CIDR"
...
printf 'Generated cloud storage profile output\n'
