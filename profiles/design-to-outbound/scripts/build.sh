...
profile_list="DST-DESIGN-TO-OUTBOUND"
last="$(date -u '+%Y-%m-%d %H:%M:%S UTC')"
services_file="$repo_root/groups/design/services.txt"
...

{
    ...
    echo "# profile=design-to-outbound"
    echo "# List: Design combined domains + CIDR"
...
printf 'Generated design profile output\n'
