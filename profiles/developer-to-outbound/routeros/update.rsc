...
# source-file=profiles/developer-to-outbound/output/list-all.rsc
...
:local url \"https://raw.githubusercontent.com/mohavise/mikrotik-dns-policy-routing/main/profiles/developer-to-outbound/output/list-all.rsc\"
...
:if (\$fileSize < \$minFileSize) do={ :log warning (\"Developer outbound update: downloaded file too small (\" . \$fileSize . \" bytes); keeping old list\"); /file remove \$fileName; :return }
