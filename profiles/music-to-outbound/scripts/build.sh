...
profile_list="DST-MUSIC-TO-OUTBOUND"
last="$(date -u '+%Y-%m-%d %H:%M:%S UTC')"
services_file="$repo_root/groups/music/services.txt"
...

{
    ...
    echo "# profile=music-to-outbound"
    echo "# List: Music combined domains + CIDR"
...
printf 'Generated music profile output\n'
