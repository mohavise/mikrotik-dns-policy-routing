...
profile_list="DST-MOBILE-APP-STORE-TO-OUTBOUND"
last="$(date -u '+%Y-%m-%d %H:%M:%S UTC')"
services_file="$repo_root/groups/mobile-app-store/services.txt"
...

{
    ...
    echo "# profile=mobile-app-store-to-outbound"
    echo "# List: Mobile App Store combined domains + CIDR"
...
printf 'Generated mobile app store profile output\n'
