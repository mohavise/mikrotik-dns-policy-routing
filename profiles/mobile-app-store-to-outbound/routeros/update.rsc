...
# source-file=profiles/mobile-app-store-to-outbound/output/list-all.rsc
...
:local url \"https://raw.githubusercontent.com/mohavise/mikrotik-dns-policy-routing/main/profiles/mobile-app-store-to-outbound/output/list-all.rsc\"
...
:if (\$fileSize < \$minFileSize) do={ :log warning (\"Mobile app store outbound update: downloaded file too small (\" . \$fileSize . \" bytes); keeping old list\"); /file remove \$fileName; :return }
