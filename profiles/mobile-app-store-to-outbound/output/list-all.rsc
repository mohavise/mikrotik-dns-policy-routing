...
# Last update: 2026-07-06 09:29:39 UTC
...
:do { add regexp="(^|.*\\.)android\\.apis\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:android.apis.google.com" } on-error={}
:do { add regexp="(^|.*\\.)android\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:android.com" } on-error={}
:do { add regexp="(^|.*\\.)android\\.googleapis\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:android.googleapis.com" } on-error={}
:do { add regexp="(^|.*\\.)androidmanagement\\.googleapis\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:androidmanagement.googleapis.com" } on-error={}
:do { add regexp="(^|.*\\.)apis\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:apis.google.com" } on-error={}
:do { add regexp="(^|.*\\.)clients1\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:clients1.google.com" } on-error={}
:do { add regexp="(^|.*\\.)clients2\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:clients2.google.com" } on-error={}
:do { add regexp="(^|.*\\.)clients3\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:clients3.google.com" } on-error={}
:do { add regexp="(^|.*\\.)clients4\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:clients4.google.com" } on-error={}
...
:do { add regexp="(^|.*\\.)gvt1\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:gvt1.com" } on-error={}
:do { add regexp="(^|.*\\.)gvt2\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:gvt2.com" } on-error={}
:do { add regexp="(^|.*\\.)gvt3\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:gvt3.com" } on-error={}
:do { add regexp="(^|.*\\.)m\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:m.google.com" } on-error={}
:do { add regexp="(^|.*\\.)notifications\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:notifications.google.com" } on-error={}
:do { add regexp="(^|.*\\.)ocsp\\.pki\\.goog\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:ocsp.pki.goog" } on-error={}
:do { add regexp="(^|.*\\.)ogs\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:ogs.google.com" } on-error={}
:do { add regexp="(^|.*\\.)payments\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:payments.google.com" } on-error={}
:do { add regexp="(^|.*\\.)pki\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:pki.google.com" } on-error={}
:do { add regexp="(^|.*\\.)play\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:play.google.com" } on-error={}
:do { add regexp="(^|.*\\.)www\\.google\\.com\$" type=FWD address-list=DST-MOBILE-APP-STORE-TO-OUTBOUND comment="google-play:www.google.com" } on-error={}
