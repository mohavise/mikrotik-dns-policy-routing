...
:local url \"https://raw.githubusercontent.com/mohavise/mikrotik-dns-policy-routing/main/services/proxmox/output/list-all.rsc\"
...
:if (\$fileSize < \$minFileSize) do={ :log warning (\"Proxmox outbound update: downloaded file too small (\" . \$fileSize . \" bytes); keeping old list\"); /file remove \$fileName; :return }
